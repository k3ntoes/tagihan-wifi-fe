				...
				<section className="container mx-auto grid items-center gap-6 pt-6 pb-8 md:py-10">
					<div className="flex flex-col items-center gap-4 text-center">
						...
						<p className="max-w-[700px] text-muted-foreground text-lg sm:text-xl">
							Platform lengkap untuk mengelola pelanggan, paket internet, dan
							penagihan bulanan dengan mudah dan efisien.
						</p>
					...
					<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
						<Card className="bg-card">
							<CardHeader>
								...
								<CardDescription>
									Atur berbagai jenis paket internet dengan kecepatan dan harga
									yang fleksibel sesuai kebutuhan bisnis Anda.
								</CardDescription>
							</CardHeader>
						</Card>
						...
						<Card className="bg-card">
							<CardHeader>
								...
								<CardDescription>
									Simpan data pelanggan dengan aman dan terorganisir. Mudah
									dicari dan dikelola kapan saja.
								</CardDescription>
							</CardHeader>
						</Card>
						...
						<Card className="bg-card">
							<CardHeader>
								...
								<CardDescription>
									Pantau status pembayaran tagihan setiap bulan. Sistem
									pencatatan yang rapi untuk keuangan yang lebih baik.
								</CardDescription>
							</CardHeader>
						</Card>
					</div>
