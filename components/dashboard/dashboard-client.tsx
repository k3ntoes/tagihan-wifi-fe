        ...
        <div className="space-y-6">
            ...
            {isAdmin && (
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card className="glass-card border-slate-700/50 hover:scale-105 transition-transform animate-slide-up" style={{ animationDelay: '0.1s' }}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium text-slate-300">
                                Total Pelanggan
                            </CardTitle>
                    ...
                    <Card className="glass-card border-slate-700/50 hover:scale-105 transition-transform animate-slide-up" style={{ animationDelay: '0.2s' }}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium text-slate-300">
                                Tagihan Bulan Ini
                            </CardTitle>
                    ...
                    <Card className="glass-card border-slate-700/50 hover:scale-105 transition-transform animate-slide-up" style={{ animationDelay: '0.3s' }}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium text-slate-300">
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-green-400 mt-1">+12.5% dari bulan lalu</p>
                        </CardContent>
                    </Card>
                </div>
            )}
            ...
            {/* Quick Actions */}
            <Card className="glass-card border-slate-700/50 animate-slide-up" style={{ animationDelay: '0.4s' }}>
                <CardHeader>
                    ...
                    {isAdmin ? (
                        <>
                            ...
                            >
                                ...
                                <p className="text-sm text-slate-400 mt-1">Buat paket WiFi baru</p>
                            </a>
                            <a
                                href="/pelanggan/new"
                                className="p-4 rounded-lg bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 transition-all hover:scale-105 cursor-pointer"
                            >
                                ...
                                <p className="text-sm text-slate-400 mt-1">Daftarkan pelanggan baru</p>
                            </a>
                            <a
                                href="/tagihan/new"
                                className="p-4 rounded-lg bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 transition-all hover:scale-105 cursor-pointer"
                            >
                                ...
                                <p className="text-sm text-slate-400 mt-1">Tambah tagihan baru</p>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <p className="text-sm text-slate-400 mt-1">Analisis pendapatan</p>
                            </a>
                        </>
                    ) : (
                        <>
                            ...
                            >
                                ...
                                <p className="text-sm text-slate-400 mt-1">Lihat semua tagihan</p>
                            </a>
                            <a
                                href="/tagihan/summary"
                                className="p-4 rounded-lg bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 transition-all hover:scale-105 cursor-pointer"
                            >
                                ...
                                <p className="text-sm text-slate-400 mt-1">Riwayat pembayaran</p>
                            </a>
                        </>
                    )}
                </CardContent>
