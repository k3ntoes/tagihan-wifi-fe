...
import { User, KeyRound, LogOut, Bell } from 'lucide-react';
            ...
            <div className="flex items-center gap-4">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-56 bg-slate-900/95 backdrop-blur-xl border-slate-700/50" align="end">
                        ...
                        <DropdownMenuItem onClick={handleProfile} className="text-slate-300 hover:text-white hover:bg-slate-700/50 cursor-pointer">
                            <User className="mr-2 h-4 w-4" />
                            Profil
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={handleChangePassword} className="text-slate-300 hover:text-white hover:bg-slate-700/50 cursor-pointer">
                            <KeyRound className="mr-2 h-4 w-4" />
                            Ubah Password
                        </DropdownMenuItem>
                        <DropdownMenuSeparator className="bg-slate-700/50" />
                        <DropdownMenuItem onClick={handleLogout} className="text-red-400 hover:text-red-300 hover:bg-slate-700/50 cursor-pointer">
